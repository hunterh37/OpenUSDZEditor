...
| RenderKit | **100%** (logic) | Unit: RenderStageParse (diffuse colours, UsdUVTexture files, usdz-relative path resolution, camera pose) + renderer-selection policy; SceneKit/Metal offscreen render + usdrecord spawn coverage-excluded (GPU/process seams) |
