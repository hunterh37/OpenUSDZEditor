...
/// real MeshKit geometry, deterministic selections, and the refineMesh step
/// wiring. The declarative side (coding + validation) is covered in SculptKit's
/// `RefinementExpressivenessTests`.
